...
3つの skill（`harness-implement` / `harness-improve` / `harness-visualize`）が
**開始直後に1回**参照する。オーナーが未登録・未接続のときに、代わりの手段で進めないための節。
...
- **CLI に mermaid や ASCII の図を貼って図の代わりにする**（→ 〈出力の作法〉6）
